...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.payment.create') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('name') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="name" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.appsettings.payment.name') }}&quot;">
                    ...
                    <div class="control-group {!! $errors->has('image.*') ? 'has-error' : '' !!}">
                        ...
                        <image-wrapper :button-label="'{{ __('admin::app.appsettings.payment.image') }}'" input-name="image" :multiple="false"></image-wrapper>
