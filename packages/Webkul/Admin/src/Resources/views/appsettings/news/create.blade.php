...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.news.create') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('title') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="title" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.appsettings.news.title') }}&quot;">
                    ...
                    <div class="control-group {!! $errors->has('image.*') ? 'has-error' : '' !!}">
                        ...
                        <image-wrapper :button-label="'{{ __('admin::app.appsettings.news.image') }}'" input-name="image" :multiple="false"></image-wrapper>
