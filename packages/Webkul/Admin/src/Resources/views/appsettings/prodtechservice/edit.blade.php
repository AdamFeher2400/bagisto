...
@section('page_title')
    {{ __('admin::app.appsettings.prodtechservice.edit-title') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.prodtechservice.update', $prodtechservice->id) }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('customer_id') ? 'has-error' : '']">
                        ...
                        <select class="control" v-validate="'required'" id="customer_id" name="customer_id" data-vv-as="&quot;{{ __('admin::app.appsettings.prodtechservice.customer') }}&quot;">
                            @foreach($customers as $key => $customer)
                                <option value="{{ $customer['id'] }}" {{ $prodtechservice->customer_id == $customer['id'] ? 'selected' : '' }}>{{ $customer['name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="control-group" :class="[errors.has('brand') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="brand" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.appsettings.prodtechservice.brand') }}&quot;" value="{{ $prodtechservice->brand ?: old('brand') }}">
                    ...
                    <div class="control-group" :class="[errors.has('model') ? 'has-error' : '']">
                        ...
                        <input type="text" class="control" name="model" v-validate="'required'" data-vv-as="&quot;{{ __('admin::app.appsettings.prodtechservice.model') }}&quot;" value="{{ $prodtechservice->model ?: old('model') }}">
                    ...
                    <div class="control-group" :class="[errors.has('arrival') ? 'has-error' : '']">
                        ...
                        <input type="date" class="control" name="arrival" data-vv-as="&quot;{{ __('admin::app.appsettings.prodtechservice.arrival') }}&quot;" value="{{ $prodtechservice->arrival ?: old('arrival') }}">
                    ...
                    <div class="control-group" :class="[errors.has('return') ? 'has-error' : '']">
                        ...
                        <input type="date" class="control" name="return" data-vv-as="&quot;{{ __('admin::app.appsettings.prodtechservice.return') }}&quot;" value="{{ $prodtechservice->return ?: old('return') }}">
                    ...
                    <div class="control-group" :class="[errors.has('status') ? 'has-error' : '']">
                        ...
                        <select class="control" v-validate="'required'" id="status" name="status" data-vv-as="&quot;{{ __('admin::app.appsettings.prodtechservice.status') }}&quot;">
                            @foreach($statuses as $key => $status)
                                <option value="{{ $status['name'] }}" {{ $prodtechservice->status == $status['name'] ? 'selected' : '' }}>{{ $status['name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="control-group" :class="[errors.has('techservice_id') ? 'has-error' : '']">
                        ...
                        <select class="control" v-validate="'required'" id="techservice_id" name="techservice_id" data-vv-as="&quot;{{ __('admin::app.appsettings.prodtechservice.techservice') }}&quot;">
                            @foreach($techservices as $key => $techservice)
                                <option value="{{ $techservice['id'] }}" {{ $prodtechservice->techservice_id == $techservice['id'] ? 'selected' : '' }}>{{$techservice['name']}}</option>
                            @endforeach
                        </select>
                    </div>
